...
/**
 * Where "exit lab" drops the annotator once the secure session is torn down.
 * Standalone that is the login screen; if you mount Label Lab inside a larger
 * product, point this at that product's home.
 */
const LAB_EXIT_PATH = "/login";
